    ...
    return (
      <div id="tamodal">
        ...
        >
          ...
          <p id="userAnswer">{answers.question1}</p>
          <p>{answers.userAnswer}</p>
          <textarea
            id="textInput"
            name="teacherAnswer1"
            ...
            // required
          />
          <p id="userAnswer2">{answers.question2}</p>
          <p>{answers.userAnswer2}</p>
          <textarea
            id="textInput"
            name="teacherAnswer2"
            placeholder="Type your response here! Click and drag to resize this box."
            // required
          />
          <p id="userAnswer3">{answers.question3}</p>
          <p>{answers.userAnswer3}</p>
          <textarea
            id="textInput"
            name="teacherAnswer3"
            placeholder="Type your response here! Click and drag to resize this box."
          ...
          <p>{answers.teacherAnswer1}</p>
          <p>{answers.question2 || "Not Done Yet!:"}</p>
          <p>{answers.teacherAnswer2}</p>
          <p>{answers.question3 || "Not Done Yet!:"}</p>
          <p>{answers.teacherAnswer3}</p>
